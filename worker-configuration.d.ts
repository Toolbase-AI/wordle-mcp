/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 79e4a08b647700308dad30445b3b84df)
// Runtime types generated with workerd@1.20250428.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WORDLE_KV: KVNamespace;
		CLERK_INSTANCE_URL: string;
		CLERK_SECRET_KEY: string;
		CLERK_BACKEND_URL: string;
		HINT_SUCCESS_URL: string;
		STRIPE_SECRET_KEY: string;
		HINT_PRICE_ID: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/worker/index").UserGameMCP>;
		USER_GAME: DurableObjectNamespace<import("./src/worker/index").UserGame>;
		DB: D1Database;
		AI: Ai;
		ASSETS: Fetcher;
	}
